...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white py-12 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <button
              onClick={scrollToTop}
              className="text-2xl font-bold mb-4 text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
            >
              Hashim Iqbal
            </button>
          ...
          <div>
            ...
            <div className="mt-4">
              <div className="flex items-center p-3 bg-green-100 dark:bg-green-900/20 rounded-lg border border-green-300 dark:border-green-800">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                <span className="text-green-700 dark:text-green-300 text-sm">Open to new opportunities</span>
              </div>
            </div>
          </div>
        </div>
